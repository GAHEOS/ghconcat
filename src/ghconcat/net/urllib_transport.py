...
from ghconcat.utils.net import DEFAULT_UA, ssl_context_for


class UrllibHTTPTransport(HTTPTransportProtocol):
    """Minimal urllib-based HTTP transport."""
    ...
    def request(self, req: FetchRequest) -> FetchResponse:
        ...
        url_req = urllib.request.Request(
            req.url, data=req.body, headers=headers, method=req.method or "GET"
        )
